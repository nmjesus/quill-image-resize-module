...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_quill_assets_icons_align_right_svg__ = __webpack_require__(33);
...
var WideClass = new Parchment.Attributor.Class('wide', '');
var SystemTagClass = new Parchment.Attributor.Class('systemtag', 'systemtag');
...
var Toolbar = function (_BaseModule) {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Toolbar.__proto__ || Object.getPrototypeOf(Toolbar)).call.apply(_ref, [this].concat(args))), _this), _this.onCreate = function () {
      ...
      _this.alignments = [{
        ...
        apply: function apply() {
          ...
          WideClass.remove(_this.img, 'wide');
        },
        ...
        icon: __WEBPACK_IMPORTED_MODULE_2_quill_assets_icons_align_right_svg___default.a,
        apply: function apply() {
          WideClass.add(_this.img, 'wide');
          DisplayStyle.remove(_this.img);
          FloatStyle.remove(_this.img);
          MarginStyle.remove(_this.img);
        },
        isApplied: function isApplied() {
          return WideClass.value(_this.img) == 'wide';
        }
      }, {
        type: 'select',
        options: _this.options.systemTagsOptions,
        apply: function apply() {
          SystemTagClass.add(_this.img, 'tag');
        },
        isApplied: function isApplied() {
          return SystemTagClass.value(_this.img).indexOf('systemtag-') !== -1;
        }
      }];
      ...
      _this.alignments.forEach(function (alignment, idx) {
        if (alignment.type === 'select' && alignment.options && alignment.options.length) {
          var select = _this._select(alignment.options);
          _this.toolbar.appendChild(select);
        }
  ...
  _createClass(Toolbar, [{
    key: '_select',
    value: function _select(options) {
      var _this2 = this;
      ...
      select.addEventListener('change', function (ev) {
        ...
        if (value) {
          SystemTagClass.add(_this2.img, value);
        } else {
          SystemTagClass.remove(_this2.img);
        }
      });
